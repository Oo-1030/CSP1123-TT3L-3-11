...
npc_assets = {
    "Fazir": {
        ...
        "win_manga": pygame.image.load(os.path.join(npc_path, "fazir_win.jpg")),
        "lose_manga": pygame.image.load(os.path.join(npc_path, "fazir_lose.jpg"))
    },
    "Rane": {
        "name": "Rane",
        "image": pygame.transform.scale(pygame.image.load(os.path.join(npc_path, "rane.png")), (200, 200)),
        "win_manga": pygame.image.load(os.path.join(npc_path, "rane_win.jpg")),
        "lose_manga": pygame.image.load(os.path.join(npc_path, "rane_lose.jpg"))
    },
    "Edeline": {
        "name": "Edeline",
        "image": pygame.transform.scale(pygame.image.load(os.path.join(npc_path, "edeline.png")), (200, 200)),
        "win_manga": pygame.image.load(os.path.join(npc_path, "edeline_win.jpg")),
        "lose_manga": pygame.image.load(os.path.join(npc_path, "edeline_lose.jpg"))
    },
    "Elves": {
        "name": "Elves",
        "image": pygame.transform.scale(pygame.image.load(os.path.join(npc_path, "elves.png")), (200, 200)),
        "win_manga": pygame.image.load(os.path.join(npc_path, "elves_win.jpg")),
        "lose_manga": pygame.image.load(os.path.join(npc_path, "elves_lose.jpg"))
    }
}
