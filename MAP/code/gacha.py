...
Calculator_img = pygame.transform.scale(pygame.image.load('CSP1123-TT3L-3-11/MAP/images/Calculaotr.png'), (image_width, image_height))
Cat_img = pygame.transform.scale(pygame.image.load('CSP1123-TT3L-3-11/MAP/images/Cat.png'), (image_width, image_height))
Icecream_img = pygame.transform.scale(pygame.image.load('CSP1123-TT3L-3-11/MAP/images/Icecream.png'), (image_width, image_height))
